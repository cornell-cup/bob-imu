...
def sensor_reading(accel_x, accel_y, accel_z, gyro_x, gyro_y, gyro_z, angle):
    """
    ...
    accel_roll, gyro_roll = calculate_data_r(accel_x, accel_y, accel_z, gyro_x, gyro_y, gyro_z, angle)
